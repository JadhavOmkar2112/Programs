/*
	...
	Input Format :
				...
				space-separated integers denoting the elements 
				of the array.
	
	Constraints :
				1 <= n <=1000
				i <=arr[i] <=1000, where arr[i] is the i^th
				element of the array.
	
	Output Format :
				The output is handled by the code given in 
				the editor, which would print the array.
